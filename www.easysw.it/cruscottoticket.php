...
if($operatoreas=="AMMINISTRATORE"){$emailwd="enrico.conforti@sacigroup.it";} 
if($operatoreas=="DOMENICO"){$emailwd="domenico.calcidese@gmail.com";}
if($operatoreas=="ANGELO"){$emailwd="angelo.calcidese@gmail.com";} 



if($operatore=="AMMINISTRATORE"){$email="enrico.conforti@sacigroup.it";} 
if($operatore=="DOMENICO"){$email="domenico.calcidese@gmail.com";}
if($operatore=="ANGELO"){$email="angelo.calcidese@gmail.com";}
#echo "fatto".$emailwd.$email; exit;
...
if (mail($emailwd, $mail_oggetto, $mail_corpo, $mail_headers))
...
$oggi=date("Y-m-d H:m:s");
   ...
   '$tessera',
   '',  
   'CHIUSO SEGNALAZIONE DA HELP DESK',
   '$oggi',
   '$login',
   '$newfile',
   'C')";
...
$oggi=date("Y-m-d H:m:s");
   ...
   '$tessera',
   '',  
   'RIAPERTURA SEGNALAZIONE DA HELP DESK',
   '$oggi',
   '$login',
   '$newfile',
   'P')";
...
<?php  if($ingranaggiox==600){ ?>
  background-color: #afc81b; /* Green */
<?php }else{?>  
  background-color: #476b5d; /* Green */
<?php }?>
  border: none;
  color: white;
  padding: 2px 20px;
...
<div align="center" >
	    ...
	    <div align="center" style="width: 60em;">
			<td style="border: 0px ; ">
			<img border="0" src="sacigroup.png" width="400" height="140"></td>
		  </div>
...
<p align="center"><b><font face="Arial" size="4" color="#993300">SEGNALAZIONI APERTI</font></b></p>
...
$sql1 = "select * from ticket  where stato = 'APERTO'  order by codice desc";
}else{
$sql1 = "select * from ticket  where stato = 'APERTO' and operatore = '$operatore' order by codice desc";
}
...
<select size="1" name="operatoreas" style="background-color: #ececee">
					<option <?php  if($operatorex=="AMMINISTRATORE"){echo "selected";}?>>AMMINISTRATORE</option>
					<option <?php  if($operatorex=="DOMENICO"){echo "selected";}?>>DOMENICO</option>
                    <option <?php  if($operatorex=="ANGELO"){echo "selected";}?>>ANGELO</option>
...
<tr>
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" ><b><?php  echo $procedura; ?></b></td>
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" ><b><?php  echo $codice; ?></b></td>	
<td valign="top" width=100 style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" >(<?php  echo $dataora; ?>)</td>	
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" ><?php  echo $argomento; ?></td>
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" ><?php  echo $descrizione; ?></td>
<?php  if($allegato!=""){?>
<?php  $comodo=explode(".",$allegato);
if($comodo[1] == "pdf"){ ?> 
<td  valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;"><a  href="JavaScript:carica_consegnaB('./tk/esponipdfff.php?fl=<?php echo $allegato; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<?php  } else { ?> 
<td  valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;"><a href="JavaScript:carica_consegnaB('esponiimage.php?fl=<?php echo $allegato; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
 <?php }?>

<?php  } else { ?>
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" >NO</td>
<?php  } ?>
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" ><?php  echo $stato; ?></td>
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" ><?php  echo $lavorazione; ?></td>
<td  valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;"><a href="?login=<?php  echo $login; ?>&ticket=<?php  echo $codice; ?>&operatore=<?php  echo $operatore; ?>&ingranaggio=1">Rispondi</a></td>  

                                                                                                               
<td valign="top" style=" border: 1px solid black;background-color: #afc81b; color: #ffffff;" ></td>
</tr>
<?php 
...
$sql1k = "SELECT * FROM utenti  where login = '$login'";
#echo $sql1k; 
...
if($ticketsi==1){$nosiletti="non letto";}else{$nosiletti="letto";}    
      ?>
<tr> 
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" ><?php if($tipomessaggio=="R"){echo $nosiletti;}?></td>
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" ></td>	
<td valign="top" width=100 style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" >(<?php  echo $dataoraw; ?>)</td>	
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" ></td>
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" ><?php  echo $descrizionew; ?></td>
<?php  if($allegatow!=""){?>
<?php  $comodo=explode(".",$allegatow);
if($comodo[1] == "pdf"){ ?>
<td  valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;"><a href="JavaScript:carica_consegnaB('./tk/esponipdfff.php?fl=<?php echo $allegatow; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<?php  } else { ?>
<td  valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;"><a href="JavaScript:carica_consegnaB('esponiimage.php?fl=<?php echo $allegatow; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<?php }?>

<?php  } else { ?>
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" >NO</td>
<?php  } ?>
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" ></td>
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" ></td>
<td  valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;"><?php  if($tipomessaggio=="D"){echo "<a href='?login=$login&ticket=$codicew&operatore=$operatore&ingranaggio=1' >Rispondi</a>";}else{if($tipomessaggio=="R" or $tipomessaggio=="P"){echo "<a href='?login=$login&ticket=$codicew&operatore=$operatore&ingranaggio=1' >Rispondi</a>";}}?></td>  


<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "476b5d";}else{echo "afc81b";} ?>; color: #ffffff;" ><?php  if($tipomessaggio=="R"){echo "<a href='?login=$login&ticket=$codicew&operatore=$operatore&ingranaggio=5' >Chiudi TK</a>";}?></td>
<td></td>
</tr>
...
<?php }?>
<?php if($ingranaggiox==600){?>
<p align="center"><b><font face="Arial" size="5" color="#993300">STORICO SEGNALAZIONI RICHIESTE E CHIUSI</font></b></p></h1><h2> 
...
<tr>
<td valign="top" style=" border: 1px solid black;background-color: #476b5d; color: #ffffff;" ><?php  echo $procedura; ?></td>
<td valign="top" style=" border: 1px solid black;background-color: #476b5d; color: #ffffff;" ><?php  echo $codice; ?></td>	
...
<?php  $comodo=explode(".",$allegato);
if($comodo[1] == "pdf"){ ?>
<td  valign="top" style=" border: 1px solid black;background-color: #476b5d; color: #ffffff;"><a style="color: #ffffff;" href="JavaScript:carica_consegnaB('./tk/esponipdfff.php?fl=<?php echo $allegato; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<?php  } else { ?>
...
<td  valign="top" style=" border: 1px solid black;background-color: #476b5d; color: #ffffff;"><a href="statotic1.php?fl=<?php echo $allegato; ?>&login=<?php echo $login; ?>&ticket="<?php  echo $codice; ?> ></a></td>  
...
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;" ><?php  echo $codicew; ?></td>	
...
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;" ></td>
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #<?php if($tipomessaggio=="C" or $tipomessaggio == "P"){echo "fbf820";}else{echo "ffffff";}?>;" ><?php  echo $descrizionew; ?></td>
<?php  
#echo "proc ".$procedura; exit;
if($allegatow!=""){?>
<?php  $comodo=explode(".",$allegatow);
if($comodo[1] == "pdf"){ 
if($procedura=="ALLGEST-T")
{
?>
<td  valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;"><a href="JavaScript:carica_consegnaB('./tk/esponipdfff.php?fl=<?php echo $allegatow; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<?php 
} else { ?>
...
{
?> 
<td  valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;"><a href="JavaScript:carica_consegnaB('./tk/esponiimage.php?fl=<?php echo $allegatow; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<?php 
} else { ?>
...
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;" ></td>
<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;" ></td>
<td  valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;"><?php  if($tipomessaggio=="D"){echo "";}else{echo "";}?></a></td>  


<td valign="top" style=" border: 1px solid black;background-color: #<?php  if($tipomessaggio=="R"){echo "afc81b";}else{echo "476b5d";} ?>; color: #ffffff;" ><?php  if($tipomessaggio=="C"){echo "<a href='?login=$login&ticket=$codicew&ingranaggio=6' >Riapri TK</a>";}?></td>
<td></td>
</tr>
