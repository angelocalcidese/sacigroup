...
if ($ingranaggio==10)
   {
$sql = "DELETE from `gruppoarticolo` where progr = '$progr'";
#echo $sql;
...
<script type="text/javascript">
        ...
        if(descrizione.value=="") { 
            alert("Error: manca GRUPPO ARTICOLO"); 
            descrizione.focus(); 
            return false; 
                            } 
...
$oggi=date("Y-m-d H:m:s");
   $sql = "INSERT INTO `gruppoarticolo`(
   `descrizione`
...
if ($conn->query($sql) === FALSE) 
    {
    $erroreriferimento="errore codice gruppo articolo già esistente";
    } 
    else
     {
...
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="5" color="#993300">TABELLA GRUPPO ARTICOLO</font></b></p>

<form method="POST" action="" name="modulo" onSubmit="return controllo();">

<table class="table-form " >
<tr>		
<td colspan="2" align="center" style="color: #ffffff;background-color: #476b5d; font-size: 16px;" >Gruppi Articoli già inseriti</td>
</tr>
<tr>
...
<?php
$sql1 = "SELECT * FROM `gruppoarticolo`  ";
#echo $sql1; 
