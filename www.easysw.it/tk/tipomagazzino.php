...
if ($ingranaggio==10)
   {
$sql = "DELETE from `tipomagazzino` where progr = '$progr'";
#echo $sql;
...
if ($conn->query($sql) === FALSE) 
    {
    $erroreriferimento="errore codice tipo magazzino già esistente";
    } 
    else
     {
...
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="5" color="#993300">TABELLA TIPO MAGAZZINO</font></b></p>

<form method="POST" action="" name="modulo" onSubmit="return controllo();">

<table class="table-form " >
<tr>		
<td colspan="2" align="center" style="color: #ffffff;background-color: #476b5d; font-size: 16px;" >Tipo Magazzino già inseriti</td>
</tr>
<tr>
...
<?php
$sql1 = "SELECT * FROM `tipomagazzino`  ";
#echo $sql1; 
