...
{
$progr=$_REQUEST["id"]; 
$descriz=$_REQUEST["descriz"];
$sql1p = "SELECT * FROM `tipodoccatcat` where descrizione = '$descriz' and codicecat = '$codice' ";
#echo $sql1p;   exit;
...
if($obbligatoriot=="SI"){$mettisino="NO";}
if($obbligatoriot=="NO"){$mettisino="SI";}
$sqlyy = "UPDATE `tipodoccatcat` set 
obbligatorio = '$mettisino'
where 
descrizione = '$descriz' and codicecat = '$codice' 
";
#echo $sqlyy;   exit;
...
$sqlyy = "UPDATE `documenti` set 
obbligatorio = '$mettisino'
where 
tipodoc = '$codice' and tipodocumento = '$descrizionerr' 
";
#echo $sqlyy;   exit;
if ($conn->query($sqlyy) === TRUE)
    { } 
...
$trovaver=0;
$sqlpx = "SELECT * FROM verifica  where    codice = '$codice' and tipodocumento = '$tipodocumento'  ";        
#echo $sqlpx;  exit;
...
{
$sql = "
DELETE from verifica where tipodocumento = '$tipodocumento' and codice = '$codice'";
#echo "<br>".$sql;
...
$sqll = "SELECT *  FROM  cat where  id = '$progr' ";  
#echo $sqll;
$rCountl = 1;
$resultl = $conn->query($sqll);
if ($resultl->num_rows > 0) {
  while($macrogruppol = $resultl->fetch_assoc())	
	{ 
    $codicedelcat= $macrogruppol["codice"];
    }}
    
$trovato=0;

$sql1p = "SELECT * FROM `tipodoccatcat` where descrizione = '$descrizioney' and codicecat = '$codicedelcat' ";
#echo $sql1p;   exit;
$resultp = $conn->query($sql1p);
if ($resultp->num_rows > 0) {
  while($macrogruppop = $resultp->fetch_assoc())
...
<p align="center"><font face="Verdana" size="4" color="#993300"  >Modifica C.A.T. <br><br>- Situazione documenti </font></b>
...
$verificati=0;
$sqlpx = "SELECT * FROM verifica  where    codice = '$codice' ";        
#echo $sqlpx;  exit;
$resultpx = $conn->query($sqlpx);
if ($resultpx->num_rows > 0) {
  while($macrogruppopx = $resultpx->fetch_assoc())	
	{ 
   $verificati++;  #echo "passo"; 
   }}
...
<font face="Verdana" size="4" color="#993300"  >  &nbsp;&nbsp;&nbsp; - Situazione verifica documenti  </font>
<?
#echo $rotto." ".$si;
if($verificati==$si){ 
echo '<img border="0" src="verde.png"  width="30" height="30">';
...
<table class="table-form "  style="text-align:left;"> 
            ...
            <td >
            <input type="text" class="required" name="ragsoc" id="ragsoc" value="<?php echo $ragsoc; ?>" maxlength="60" size="60" >
            </td>
            </tr>
            ...
            <td >
            <input type="text" name="passaccessoamm" id="passaccessoamm" value="<?php echo $passaccessoamm; ?>" maxlength="60" size="60" >
            </td>
			</tr>
<!--            
            <tr>
...
-->            
            ...
            <td >
            <input type="text" name="passaccessoop" id="passaccessoop" value="<?php echo $passaccessoop; ?>" maxlength="60" size="60" >
            </td>
			</tr>
<!--            
            <tr>
...
<p align="center"><font   size="4" color="#993300">Documenti </font></b></p><div align="center">    
...
<tr onMouseOver="style.background='#c9cacb';" onMouseOut="style.background=''">
        ...
        <td  width="10%" align="center"><font size="2"   color="<?php if($prgr==$prgry){echo "#cc0000";}else{echo "#000000";} ?>"><? echo $datasca; ?></td>
...
<!--        <a  onclick="myFunction('?fileh=<?php echo $file; ?>&login=<?php echo $login; ?>&prgrx=<? echo $prgr; ?>&ingranaggio=10&ingranaggiott=202&oggetto=<?php echo $oggettox; ?>&progr=<?php echo $progr; ?>');"  ><img border="0" background="btn1.gif" src="x1.png" width="15" height="15"></a>   -->
        <a href="?fileh=<?php echo $file; ?>&login=<?php echo $login; ?>&prgrx=<? echo $prgr; ?>&ingranaggio=10&ingranaggiott=202&prgry=<?php echo $prgr; ?>&progr=<?php echo $progr; ?>&codice=<? echo $codice; ?>" onclick="return confirm('Sei sicuro di volere cancellare?')"><img border="0" src="x1.png" width="15" height="15"></a>
        </td>
...
<table class="table-form "  style="text-align:left;">
      ...
      <td colspan="1" style="background-color:#476b5d;" width="5%" align="center"><font size="2" color="#FFFFFF">SIT..&nbsp;&nbsp;</td>
      <td colspan="1" style="background-color:#476b5d;" width="5%" align="center"><font size="2" color="#FFFFFF">VER.&nbsp;&nbsp;</td>
...
?>
<tr>
<td align="center"><font size="3"  ><a  href="?login=<?php echo $login; ?>&descriz=<? echo $descrizioney; ?>&id=<? echo $progr; ?>&codice=<?php echo $codice; ?>&ingranaggio=1099&codice=<?php echo $codice; ?>"  ><? echo $obbligatorioy; ?></a></td>
...
<td>
<? if($trovato==1){ ?>
<img border="0" src="verde.png"  width="27" height="27">
<? } else { ?>
...
$sqlpx = "SELECT * FROM verifica  where  codice = '$codice' and tipodocumento = '$descrizioney'  ";        
#echo "messaggio".$sqlpx;  exit;
$resultpx = $conn->query($sqlpx);
if ($resultpx->num_rows > 0) {
  while($macrogruppopx = $resultpx->fetch_assoc())	
	{ 
...
?>
		 ...
		 <input type="hidden" name="ingranaggio" value="799" />
         <input type="hidden" name="login" value="<? echo $login; ?>" />
         <input type="hidden" name="codice" value="<? echo $codice; ?>" />
         <input type="hidden" name="id" value="<? echo $progr; ?>" />
         <input type="hidden" name="tipodocumento" value="<? echo $descrizioney; ?>" />
         <input type="image" src="rosso.png"   alt="Invia" >
...
?>
         ...
         <input type="hidden" name="tipodocumento" value="<? echo $descrizioney; ?>" />
         <input type="hidden" name="id" value="<? echo $progr; ?>" />
         <input type="image" src="verde.png"   alt="Invia" >
...
<?php  }} ?>
    ...
    <input type="hidden" name="login" value="<?php echo $login; ?>" />             
    <button  type="submit" class="btn btn-warning">Ricerca CAT</button>
    </td> 
</form>
  </tr> 
...
<table id="tableFooter" class="display" cellspacing="0" align="center" style="width:98%; position:relative;">         
	...
	<tr class="testa">
          ...
          <td  colspan="1" style="  border: 1px solid black;background-color: #476b5d; color: #ffffff;" align="center"><font size="2"  >Documenti</td>
          <td  colspan="1" style="  border: 1px solid black;background-color: #476b5d; color: #ffffff;" align="center"><font size="2"  >Verifica</td>
...
?>     
	<tr >
      ...
      <td  align="left" bgcolor="<? echo $colore; ?>"><?php echo $cognomeop; ?></td>
      <td  align="left" bgcolor="<? echo $colore; ?>"><?php echo $cognomelog; ?></td>  
      <td  align="center" bgcolor="<? echo $colore; ?>">
<?
      $si=0;
$sqlt = "SELECT * FROM tipodoccatcat where codicecat = '$codice'  ";        
#echo $sqlt;
...
#echo $rotto." ".$si;
if($rotto==$si){ 
echo '<img border="0" src="verde.png"  width="20" height="20">';
 } else {
echo  '<img border="0" src="rosso.png"  width="20" height="20">';
 }  ?>
...
echo  '<img border="0" src="rosso.png"  width="20" height="20">';
      ...
      <td  align="center" ><a  href="cercacat.php?login=<?php echo $login; ?>&progr=<?php echo $progr; ?>&ingranaggio=10&codice=<? echo $codice; ?>"  ><img border="0" background="btn1.gif" src="occhio.png" width="20" height="20"></a></td>
      <td  align="center" ><a  href="cercacat.php?login=<?php echo $login; ?>&progr=<?php echo $progr; ?>&ingranaggio=11&codice=<? echo $codice; ?>"  ><img border="0" background="btn1.gif" src="pencil.png" width="20" height="20"></a></td>
