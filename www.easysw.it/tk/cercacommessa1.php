...
$ingranaggiomatrice=$_REQUEST["ingranaggiomatrice"];
$ingranaggiomatricex=$_REQUEST["ingranaggiomatricex"];
$tipointerventomatr=$_REQUEST["tipointerventomatr"];
$tipointerventoyy=$_REQUEST["tipointerventoyy"];
$ingranaggiott=$_REQUEST["ingranaggiott"];
$ingranaggiodocu=$_REQUEST["ingranaggiodocu"];
$ingranaggiovedi=$_REQUEST["ingranaggiovedi"];
$ingranaggioscrivipas=$_REQUEST["ingranaggioscrivipas"];
$ingranaggiomodcat=$_REQUEST["ingranaggiomodcat"];
#echo "scrivo".$ingranaggioscrivipas; 
$BBAA=$_REQUEST["BBAA"];
...
#echo "tipo intervento ".$tipointervento."<br>";
...
$tipofatta1xq=$_REQUEST["tipofatta1xq"];
$numgiorq=$_REQUEST["numgiorq"];
$importogiorq=$_REQUEST["importogiorq"];
$importoa1q=$_REQUEST["importoa1q"];
$canonesinoq=$_REQUEST["canonesinoq"];
$da1a301q=$_REQUEST["da1a301q"];
$da31a601q=$_REQUEST["da31a601q"];
$da61a901q=$_REQUEST["da61a901q"];
$da91a1201q=$_REQUEST["da91a1201q"];
$da121a1501q=$_REQUEST["da121a1501q"];
$da151a1801q=$_REQUEST["da151a1801q"];
$da181a2101q=$_REQUEST["da181a2101q"];
$da211a2401q=$_REQUEST["da211a2401q"];
$da241a2701q=$_REQUEST["da241a2701q"];
$da271a3001q=$_REQUEST["da271a3001q"];
$da301a3301q=$_REQUEST["da301a3301q"];
$da331a3601q=$_REQUEST["da331a3601q"];
$da361a3901q=$_REQUEST["da361a3901q"];
$da391a4201q=$_REQUEST["da391a4201q"];
$da421a4501q=$_REQUEST["da421a4501q"];
$da451a4801q=$_REQUEST["da451a4801q"];
...
###################################  ELABORO MEMORIZZAZIONE IMPORTI PASSIVI  #############
if($ingranaggioscrivipas==1){
...
$sql = "SELECT *  FROM  selezionaticat  where login = '$login' and cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento' ";  
#echo "leggo selcat ".$sql; 
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
		{ 
 $codicecat = $macrogruppo["numero"];  
 $codicecat = sprintf("%'.03d", $codicecat); 
 
$sqlzz = "SELECT *  FROM  matrice  where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento' ";  
#echo "leggo matrice ".$sql; 
$resultzz = $conn->query($sqlzz);
if ($resultzz->num_rows > 0) {
  while($macrogruppozz = $resultzz->fetch_assoc())
		{
$importoa1q= $macrogruppozz["importoa1"];
$numgiorq= $macrogruppozz["numgior"];
$importogiorq= $macrogruppozz["importogior"];
$canonesinoq= $macrogruppozz["canonesino"];
$da1a301q= $macrogruppozz["da1a301"];
$da31a601q= $macrogruppozz["da31a601"];
$da61a901q= $macrogruppozz["da61a901"];
$da91a1201q= $macrogruppozz["da91a1201"];
$da121a1501q= $macrogruppozz["da121a1501"];
$da151a1801q= $macrogruppozz["da151a1801"];
$da181a2101q= $macrogruppozz["da181a2101"];
$da211a2401q= $macrogruppozz["da211a2401"];
$da241a2701q= $macrogruppozz["da241a2701"];
$da271a3001q= $macrogruppozz["da271a3001"];
$da301a3301q= $macrogruppozz["da301a3301"];
$da331a3601q= $macrogruppozz["da331a3601"];
$da361a3901q= $macrogruppozz["da361a3901"];
$da391a4201q= $macrogruppozz["da391a4201"];
$da421a4501q= $macrogruppozz["da421a4501"];
$da451a4801q= $macrogruppozz["da451a4801"];
$tipofattaxq= $macrogruppozz["tipofatta1"]; 
}}       
 $ce=0;
$sqlfg = "SELECT * FROM tipointerventopas  where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento1' and cat = '$codicecat' ";        
#echo $sqlfg;
$resultfg = $conn->query($sqlfg);
if ($resultfg->num_rows > 0) {
  while($macrogruppofg = $resultfg->fetch_assoc())	
	{ $ce=1;}}
...
login='$login',
importoa1='$importoa1q',
canonesino='$canonesinoq',
da1a301='$da1a301q',
da31a601='$da31a601q',
da61a901='$da61a901q',
da91a1201='$da91a1201q',
da121a1501='$da121a1501q',
da151a1801='$da151a1801q',
da181a2101='$da181a2101q',
da211a2401='$da211a2401q',
da241a2701='$da241a2701q',
da271a3001='$da271a3001q',
da301a3301='$da301a3301q',
da331a3601='$da331a3601q',
da361a3901='$da361a3901q',
da391a4201='$da391a4201q',
da421a4501='$da421a4501q',
da451a4801='$da451a4801q',
numgior='$numgiorq',
importogior='$importogiorq',
tipofatta1='$tipofattaxq'
where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento1' and cat = '$codicecat'
";
#echo $sql;
if ($conn->query($sql) === TRUE)
    { } 
...
$sqlbb = "DELETE FROM `selezionaticat` where numero  = '$codicecat' and login = '$login' and cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento' ";
#echo $sqlbb; 
if ($conn->query($sqlbb) === TRUE)
        {  } else { echo $sqlbb."Errore inserimento recoerd: " . $conn->error; }                  
         }}
}

###################################  FINE MEMORIZZAZIONE IMPORTI PASSIVI  ################

###################################  ELABORO MATRICE INSERISCO O MODIFICO  #############
if($ingranaggiomatrice==1){
$esiste=0;
$sql = "SELECT *  FROM  matrice  where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointerventomatr' ";  
#echo "leggo matrice ".$sql; 
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
...
numgior='$numgiorq',
importogior='$importogiorq',
tipofatta1='$tipofatta1xq'
where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointerventomatr'
";
#echo $sql;
if ($conn->query($sql) === TRUE)
    { } 
...
###################################  FINE ELABORAZIONE MATRICE  ########################

###################################  update passivo di cat  ############################
if($ingranaggiomatricex==1){
#echo "fatt1 ".$tipofatta1xq; exit;
$sql = "UPDATE tipointerventopas set 
login='$login',
importoa1='$importoa1q',
canonesino='$canonesinoq',
...
tipofatta1='$tipofatta1xq',
asterisco='*'
where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento1' and cat = '$catscelto'
";
#echo $sql;
if ($conn->query($sql) === TRUE)
    { } 
...
##################################### FINE UPDATE TIPO INTERVENTO ############################## 

#####################################  SCRIVO TIPO INTERVENTO  #################################
if($ingranaggiox==20){ 
#echo "reg ".$regione;
...
if ($ingranaggio==100)
   { 
$errore="";
$nomecommessa=str_replace("'", "\'", $nomecommessa);      
$sql = "Update commesse set                           
cliente='$cliente', 
attivita='$attivita', 
rif='$rif', 
...
<? ##################################   FINE ESPOSIZIONE COMMESSA ###########################  ?>   

<? ##################################   ESPOSIZIONE DOCUMENTI COMMESSA  #####################  ?> 
</td>
...
<? ###########################################   FINE ESPOSIZIONE DOCUMENTI DELLA COMMESSA  ##########################  ?>

<? ########################################### ESPOSIZIONE ELENCO DEI TIPI DI INTERVENTO  ############################  ?>
</tr>
<tr>
...
<? ########################################  INSERISCE NUOVO TIPO INTERVENTO O MODIFICA TIPO INTERVENTO ######################## ?>
<? 
...
<td align="left" width="50%" valign="top">                           
<table class="table-form "  style="text-align:left;">
<p align="center"><font face="Verdana" size="4" color="#993300" style="font-family: Verdana;"><? if($modificatipo==1){echo "Modifica Tipo Intervento";} else {echo "Inserisci Nuovo Tipo Intervento";} ?></font></b></p>
...
<? ####################################  FINE INSERIMENTO O MODIFICA TIPO DI INTERVENTO ##################################  ?>

<? ####################################  VISUALIZZA O INSERISCI DOCUMENTI ALLEGATI AL TIPO INTERVENTO ####################  ?>
<br><br><br><br><br><br>
</td>
<td align="left" width="50%" valign="top">
...
<?
$sql = "SELECT * FROM documenti  where    tipodoc = '$tipointervento' and commessa = '$commessa' and cliente = '$cliente'";        
#echo $sql;
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())	
...
<? ################################  FINE ESPONI INSERISCI DOCUMENTI TIPO DI INTERVENTO  ############################ ?>

<? ################################  LISTA DEI CAT CHE HANNO GIA MEMORIZZATO GLI IMPORTI PASSIVI DEL TIPO DI INTERVENTO #################### ?>
</tr>
<tr>
<td colspan="2">
<p align="center"><font face="Verdana" size="4" style="font-family: Verdana;" color="#993300">IMPORTI PASSIVI - CAT che hanno per questo Tipo intervento il calcolo passivo</font></b></p>   
...
/*
$sqlmm = "SELECT *  FROM  tipointervento  where progr = '$cerca' ";  
#echo $sql;  
$resultmm = $conn->query($sqlmm);
if ($resultmm->num_rows > 0) {
  while($macrogruppomm = $resultmm->fetch_assoc())
		{     
$tipointervento= $macrogruppo["tipointervento"]; 
$tipointervento1= $macrogruppo["tipointervento1"];
 }}
...
$asterisco="";
$ce=0;
$sqlll = "SELECT * FROM tipointerventopas  where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento1' and cat = '$codice'";        
#echo $sqlll;
$resultll = $conn->query($sqlll);
if ($resultll->num_rows > 0) {
  while($macrogruppoll = $resultll->fetch_assoc())	
	{ $ce=1;
     $asterisco= $macrogruppoll["asterisco"];
    }}
$oggi=date("Y-m-g H.m.s");  
if($ce==1){ 
if($codice==$catscelto){$colorepp = "#fd0101";}else{$colorepp = "#000000";} 
?>     
	  <tr>        
      <td style="color: <? echo $colorepp; ?>;" align="left" bgcolor="<? echo $colore; ?>"><?php echo $codice; ?></td>
      ...
      <td style="color: <? echo $colorepp; ?>;" align="left" bgcolor="<? echo $colore; ?>"><?php echo $cognomeamm; ?></td>
      <td style="color: <? echo $colorepp; ?>;" align="left" bgcolor="<? echo $colore; ?>"><?php echo $cognomeop; ?></td>
      <td style="color: <? echo $colorepp; ?>;" align="left" bgcolor="<? echo $colore; ?>"><?php echo $cognomelog; ?></td> 
         
      <td  align="center" ><a  href="?cerca=<?php echo $progry; ?>&progr=<?php echo $progr; ?>&login=<?php echo $login; ?>&progrw=<?php echo $cerca; ?>&cliente=<?php echo $cliente; ?>&commessa=<?php echo $commessa; ?>&ingranaggio=11&modificatipo=1&tipointerventoyy=<?echo $tipointervento; ?>&ingranaggiomodcat=1&catscelto=<? echo $codice; ?>&nomecat=<? echo $ragsoc; ?>"   ><img border="0" background="btn1.gif" src="pencil.png" width="20" height="20"></a></td>     
      <td style="color: <? echo $colorepp; ?>;" align="center" bgcolor="<? echo $colore; ?>"><font size="6"  ><?php echo $asterisco; ?></font></td>
     </tr>	     
<?php          
}
}
...
<? ################### FINE LISTA CAT CHE HANNO GIA MEMORIZZATO GLI IMPORTI PASSIVI DEL TIPO DI INTERVENTO ############################ ?>

<? #########################  ESPOSIZIONE ED MEMORIZZA MATRICE IMPORTI PASSIVI DA ATTRIBUIRE AL CAT RELATIVAMENTE AL TIPO DI INTERVENTO ############## ?>
</tr>
<tr>
<td colspan="2">
<? if($ingranaggiomodcat==1){ ?>
<p align="center"><font face="Verdana" size="4" style="font-family: Verdana;" color="#993300">Modifica Importi Passivi Tipo Intervento <? echo "'".$tipointervento1."'"; ?></font><font face="Verdana" size="4" style="font-family: Verdana;" color="#cc0000"> CAT <? echo $catscelto." ".$nomecat; ?></font> </b></p>   
<? } else { ?>
<p align="center"><font face="Verdana" size="4" style="font-family: Verdana;" color="#993300">Determinazione Importi Passivi </font><font face="Verdana" size="4" style="font-family: Verdana;" color="#cc0000"><b> MATRICE</b></font> </b></p>   
<? } ?>
<? #################################### leggi matrice ########################### 
# azzero tutti i campi prima di leggere la matrice 
$importoa1q= "";
$numgiorq= "";
$importogiorq= "";
$canonesinoq= "";
...
if($ingranaggiomodcat!=1){ 
$sql = "SELECT *  FROM  tipointervento  where progr = '$cerca' ";  
#echo "leggi tipi intervento ".$sql."<br>";  
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
		{
$commessay= $macrogruppo["commessa"]; 
$clientey= $macrogruppo["cliente"];       
$tipointerventomatr= $macrogruppo["tipointervento"];        
$tipointervento1= $macrogruppo["tipointervento1"];
}}
$sql = "SELECT *  FROM  matrice  where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointerventomatr' ";  
#echo "leggo matrice ".$sql; 
...
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
		{
$importoa1q= $macrogruppo["importoa1"];
$numgior= $macrogruppo["numgior"];
$importogiorq= $macrogruppo["importogior"];
$canonesinoq= $macrogruppo["canonesino"];
$da1a301q= $macrogruppo["da1a301"];
$da31a601q= $macrogruppo["da31a601"];
$da61a901q= $macrogruppo["da61a901"];
$da91a1201q= $macrogruppo["da91a1201"];
$da121a1501q= $macrogruppo["da121a1501"];
$da151a1801q= $macrogruppo["da151a1801"];
$da181a2101q= $macrogruppo["da181a2101"];
$da211a2401q= $macrogruppo["da211a2401"];
$da241a2701q= $macrogruppo["da241a2701"];
$da271a3001q= $macrogruppo["da271a3001"];
$da301a3301q= $macrogruppo["da301a3301"];
$da331a3601q= $macrogruppo["da331a3601"];
$da361a3901q= $macrogruppo["da361a3901"];
$da391a4201q= $macrogruppo["da391a4201"];
$da421a4501q= $macrogruppo["da421a4501"];
$da451a4801q= $macrogruppo["da451a4801"];
$tipofattaxq= $macrogruppo["tipofatta1"]; 
}}
} else {
$sql = "SELECT *  FROM  tipointerventopas  where cliente = '$cliente' and commessa = '$commessa' and tipointervento = '$tipointervento1' and cat = '$catscelto' ";  
#echo "leggo pas ".$sql; 
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
...
<td colspan="2">
<label>Tipo Fatturazione:</label>
<select class="required" size="1" name="tipofatta1xq" id="tipofatta1xq" >
<?
$sql = "SELECT * FROM tipofattura  order by descrizione";        
#echo $sql;
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())	
	{ $descrizione = $macrogruppo["descrizione"]; ?>
      <option <? if($descrizione==$tipofatta1xq){echo "selected";}?>><? echo $descrizione; ?></option>
<? }} ?>           
</select>
</td>
</tr>
...
<tr>
            <td colspan="2" >
            <label>Importo singolo ticket:</label>
            <input type="text" name="importoa1q" value="<?php echo $importoa1q; ?>" maxlength="200" >
            </td>
</tr>
<tr>
            <td colspan="2" >
            <label>Importo in canone:</label>            
            <select size="1" name="canonesinoq" style="background-color: #ececee">
			<option <?php  if($canonesinoq=="NO"){echo "selected";}?>>NO</option>
            <option <?php  if($canonesinoq=="SI"){echo "selected";}?>>SI</option>
			</select>           
            </td>
</tr>
<tr>
            ...
            <td colspan="2" >
            <label>Importo Giornaliero:</label>
            <input type="text" name="importogiorq" value="<?php echo $importogiorq; ?>" maxlength="10" >
            </td>
</tr>
<tr>
...
<tr>            
            <td width="15%" align="center">1</td>
            <td width="15%" align="center">30</td>
            <td>Totale: <span id="tot-somma0q"></span></td>
            <td><input type="number" name="da1a301q"  id="da1a301q" value="<?php echo $da1a301q; ?>" onKeyup="totalq()" onClick="totalq()" maxlength="10" ></td>
            
</tr>
<tr>
            <td width="15%" align="center">31</td>
            <td width="15%" align="center">60</td>
            <td>Totale: <span id="tot-somma1q"></span></td>
            <td><input type="number" name="da31a601q" id="da31a601q" value="<?php echo $da31a601q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10" ></td>
           
</tr>
<tr>
            <td width="15%" align="center">61</td>
            <td width="15%" align="center">90</td>
            <td>Totale: <span id="tot-somma2q"></span></td>
            <td><input type="number" name="da61a901q" id="da61a901q" value="<?php echo $da61a901q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10" ></td>
            ...
            <td width="15%" align="center">91</td>
            <td width="15%" align="center">120</td>
            <td>Totale: <span id="tot-somma3q"></span></td>
            <td><input type="number" name="da91a1201q" id="da91a1201q" value="<?php echo $da91a1201q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
            
</tr>
            <tr>
            <td width="15%" align="center">121</td>
            <td width="15%" align="center">150</td>
            <td>Totale: <span id="tot-somma4q"></span></td>
            <td><input type="number" name="da121a1501q" id="da121a1501q" value="<?php echo $da121a1501q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
          
            </tr>
            <tr>
            <td width="15%" align="center">151</td>
            <td width="15%" align="center">180</td>
            <td>Totale: <span id="tot-somma5q"></span></td>
            <td><input type="number" name="da151a1801q" id="da151a1801q" value="<?php echo $da151a1801q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
            ...
            <td width="15%" align="center">181</td>
            <td width="15%" align="center">210</td>
            <td>Totale: <span id="tot-somma6q"></span></td>
            <td><input type="number" name="da181a2101q" id="da181a2101q" value="<?php echo $da181a2101q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
</tr>
            <tr>
            <td width="15%" align="center">211</td>
            <td width="15%" align="center">240</td>
            <td>Totale: <span id="tot-somma7q"></span></td>
            <td><input type="number" name="da211a2401q" id="da211a2401q" value="<?php echo $da211a2401q; ?>"  onKeyup="totalq()" onClick="totalq()"maxlength="10"  ></td>
          
</tr>
            <tr>
            <td width="15%" align="center">241</td>
            <td width="15%" align="center">270</td>
            <td>Totale: <span id="tot-somma8q"></span></td>
            <td><input type="number" name="da241a2701q" id="da241a2701q" value="<?php echo $da241a2701q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
</tr>
            
             <tr>
            <td width="15%" align="center">271</td>
            <td width="15%" align="center">300</td>
            <td>Totale: <span id="tot-somma9q"></span></td>
            <td><input type="number" name="da271a3001q" id="da271a3001q" value="<?php echo $da271a3001q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>

</tr>
            <tr>
            <td width="15%" align="center">301</td>
            <td width="15%" align="center">330</td>
            <td>Totale: <span id="tot-somma10q"></span></td>
            <td><input type="number" name="da301a3301q" id="da301a3301q" value="<?php echo $da301a3301q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
           
</tr>
            <tr>
            <td width="15%" align="center">331</td>
            <td width="15%" align="center">360</td>
            <td>Totale: <span id="tot-somma11q"></span></td>
            <td><input type="number" name="da331a3601q" id="da331a3601q" value="<?php echo $da331a3601q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
            
</tr>
             <tr>
            <td width="15%" align="center">361</td>
            <td width="15%" align="center">390</td>
            <td>Totale: <span id="tot-somma12q"></span></td>
            <td><input type="number" name="da361a3901q" id="da361a3901q" value="<?php echo $da361a3901q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10" ></td>
            ...
            <td width="15%" align="center">391</td>
            <td width="15%" align="center">420</td>
            <td>Totale: <span id="tot-somma13q"></span></td>
            <td><input type="number" name="da391a4201q" id="da391a4201q" value="<?php echo $da391a4201q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10"  ></td>
          
</tr>
            <tr>
            <td width="15%" align="center">421</td>
            <td width="15%" align="center">450</td>
            <td>Totale: <span id="tot-somma14q"></span></td>
            <td><input type="number" name="da421a4501q" id="da421a4501q" value="<?php echo $da421a4501q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10" ></td>
</tr>
            <tr>
            <td width="15%" align="center">451</td>
            <td width="15%" align="center">480</td>
            <td>Totale: <span id="tot-somma15q"></span></td>
            <td><input type="number" name="da451a4801q" id="da451a4801q" value="<?php echo $da451a4801q; ?>"  onKeyup="totalq()" onClick="totalq()" maxlength="10" ></td>
</tr>
...
<tr>       
    ...
    <input type="hidden" name="ingranaggiomatrice" value="1 />       
    <input type="hidden" name="cerca" value="<?php echo $progry; ?>" /> 
    <input type="hidden" name="progr" value="<?php echo $progr; ?>" /> 
    ...
    <input type="hidden" name="cliente" value="<?php echo $cliente; ?>" /> 
    <input type="hidden" name="commessa" value="<?php echo $commessa; ?>" />  
    <input type="hidden" name="tipointerventomatr" value="<?php echo $tipointerventomatr; ?>" />
    <button  type="submit" class="btn btn-warning">Memorizza Matrice Passiva</button>
    </td> 
<? }else { ?> 
<tr>       
    <td colspan="4" style="text-align: center; " > 
    <input type="hidden" name="ingranaggiomatricex" value="1 />       
    <input type="hidden" name="cerca" value="<?php echo $progry; ?>" /> 
    <input type="hidden" name="progr" value="<?php echo $progr; ?>" /> 
    <input type="hidden" name="catscelto" value="<?php echo $catscelto; ?>" /> 
    <input type="hidden" name="login" value="<?php echo $login; ?>" /> 
    <input type="hidden" name="progrw" value="<?php echo $cerca; ?>" /> 
    <input type="hidden" name="cliente" value="<?php echo $cliente; ?>" /> 
    <input type="hidden" name="commessa" value="<?php echo $commessa; ?>" />  
    <input type="hidden" name="tipointervento1" value="<?php echo $tipointervento1; ?>" />
    <button  type="submit" class="btn btn-warning">Modifica Passivo CAT</button>
    </td> 
<? } ?>
...
<tr>
        <th colspan="2" class=" borted-top-table" style="background-color: #afc81b;"> 
        Importi Attivi :
        </th>          
</tr>          
<tr>
            <td colspan="2" style="background-color: #f9feda;">
            <label>Importo singolo ticket:</label>
            <input type="number" name="importoa1" value="<?php echo $importoa1; ?>" maxlength="200" >
            </td>
</tr>
<tr>
            <td colspan="2" style="background-color: #f9feda;">
            <label>Importo in canone:</label>
            <input type="number" name="canone1" value="<?php echo $canone1; ?>" maxlength="200" >
            </td>
</tr>
<tr>
            ...
            <td colspan="2" style="background-color: #f9feda;">
            <label>Importo Giornaliero:</label>
            <input type="number" name="importogior" value="<?php echo $importogior; ?>" maxlength="10" >
            </td>
</tr>
<tr>
            <th colspan="2" class=" borted-top-table" style="background-color: #afc81b;"> 
...
<table class="table-form "  style="text-align:left;">
<tr>
            <td colspan="2" align="center" style="background-color: #f9feda;">TIME(minuti)</td>
            <td colspan="2" align="center" style="background-color: #f9feda;">Importo Ticket</td> 
                      
</tr>
<tr>            
            <td width="25%" align="center" style="background-color: #f9feda;">1</td>
            <td width="25%" align="center" style="background-color: #f9feda;">30</td>
            <td style="background-color: #f9feda;"><input type="number" name="da1a301"  id="p1" value="<?php echo $da1a301; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15" ></td>
           
</tr>
<tr>
            <td width="25%" align="center" style="background-color: #f9feda;">31</td>
            <td width="25%" align="center" style="background-color: #f9feda;">60</td>
            <td style="background-color: #f9feda;"><input type="number" name="da31a601" id="p2" value="<?php echo $da31a601; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15" ></td>
            
</tr>
<tr>
            <td width="25%" align="center" style="background-color: #f9feda;">61</td>
            <td width="25%" align="center" style="background-color: #f9feda;">90</td>
            <td style="background-color: #f9feda;"><input type="number" name="da61a901" id="p3" value="<?php echo $da61a901; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15" ></td>
            
</tr>
            
             <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">91</td>
            <td width="25%" align="center"style="background-color: #f9feda;" >120</td>
            <td style="background-color: #f9feda;"><input type="number" name="da91a1201" id="p4" value="<?php echo $da91a1201; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
          
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">121</td>
            <td width="25%" align="center" style="background-color: #f9feda;">150</td>
            <td style="background-color: #f9feda;"><input type="number" name="da121a1501" id="p5" value="<?php echo $da121a1501; ?>"  onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">151</td>
            <td width="25%" align="center" style="background-color: #f9feda;">180</td>
            <td style="background-color: #f9feda;"><input type="number" name="da151a1801" id="p6" value="<?php echo $da151a1801; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
            
            
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">181</td>
            <td width="25%" align="center" style="background-color: #f9feda;">210</td>
            <td style="background-color: #f9feda;"><input type="number" name="da181a2101" id="p7" value="<?php echo $da181a2101; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">211</td>
            <td width="25%" align="center" style="background-color: #f9feda;">240</td>
            <td style="background-color: #f9feda;"><input type="number" name="da211a2401" id="p8" value="<?php echo $da211a2401; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">241</td>
            <td width="25%" align="center" style="background-color: #f9feda;">270</td>
            <td style="background-color: #f9feda;"><input type="number" name="da241a2701" id="p9" value="<?php echo $da241a2701; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
            
             <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">271</td>
            <td width="25%" align="center" style="background-color: #f9feda;">300</td>
            <td style="background-color: #f9feda;"><input type="number" name="da271a3001" id="p10" value="<?php echo $da271a3001; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
           
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">301</td>
            <td width="25%" align="center" style="background-color: #f9feda;">330</td>
            <td style="background-color: #f9feda;"><input type="number" name="da301a3301" id="p11" value="<?php echo $da301a3301; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">331</td>
            <td width="25%" align="center" style="background-color: #f9feda;">360</td>
            <td style="background-color: #f9feda;"><input type="number" name="da331a3601" id="p12" value="<?php echo $da331a3601; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
             <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">361</td>
            <td width="25%" align="center" style="background-color: #f9feda;">390</td>
            <td style="background-color: #f9feda;"><input type="number" name="da361a3901" id="p13" value="<?php echo $da361a3901; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15" ></td>
         
            </tr>
            
             <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">391</td>
            <td width="25%" align="center" style="background-color: #f9feda;">420</td>
            <td style="background-color: #f9feda;"><input type="number" name="da391a4201" id="p14" value="<?php echo $da391a4201; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15"  ></td>
            
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">421</td>
            <td width="25%" align="center" style="background-color: #f9feda;">450</td>
            <td style="background-color: #f9feda;"><input type="number" name="da421a4501" id="p15" value="<?php echo $da421a4501; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15" ></td>
            
            </tr>
            <tr>
            <td width="25%" align="center" style="background-color: #f9feda;">451</td>
            <td width="25%" align="center" style="background-color: #f9feda;">480</td>
            <td style="background-color: #f9feda;"><input type="number" name="da451a4801" id="p16" value="<?php echo $da451a4801; ?>" onKeyup="totalt()" onClick="totalt()" maxlength="15" ></td>
            
            </tr>

            <tr>
            <td style="background-color: #f9feda;"></td>
            <td style="background-color: #f9feda;"></td>
            <td style="background-color: #f9feda;">Totale: <span id="tot-sommat"></span></td>
            <td ></td>
            </tr>
...
<? ##############################  FINE MEMORIZZAZIONE MATRICE PASSIVA ############################### ?>

<? ############################## ELENCO CAT CHE NON HANNO MEMORIZZATO GLI IMPORTI PASSIVI DI QUESTO TIPO DI INTERVENTO ################# ?>
<br> 

<p align="center"><font face="Verdana" size="4" style="font-family: Verdana;" color="#993300">IMPORTI PASSIVI - CAT che <b>NON</b> hanno per questo Tipo intervento il calcolo passivo</font></b></p>   

<table id="tableFooterzz" class="display" cellspacing="0" align="center" style="width:98%; position:relative;">         
             <thead class="intesta">
	<tr class="testa">
          ...
          <td  colspan="1" style="  border: 1px solid black;background-color: #476b5d; color: #ffffff;" align="center"><font size="2"  >Rif. Operativo</td>                                                     
          <td  colspan="1" style="  border: 1px solid black;background-color: #476b5d; color: #ffffff;" align="center"><font size="2"  >Rif. Logistica</td>                                     
          <td  colspan="1" style="  border: 1px solid black;background-color: #476b5d; color: #ffffff;" align="center"><font size="2"  >Seleziona</td>                   
...
<?
$ce=0;
$sqlyy = "SELECT *  FROM  selezionaticat where  (numero  = '$codice') and (login = '$login')  " ;  
  #echo $sqlyy;
  $rCount = 1;
...
<!--  qui mettere la lettura cecked  -->
      <input style="width: 20px;  height: 20px;" type="checkbox" onClick="attivaclick(<?php echo $codice; ?>, '<?php echo $login; ?>', '<? echo $cliente; ?>', '<? echo $commessa; ?>', '<? echo $tipointervento; ?>')"  <?php if($ce==1){echo "checked";} ?> name="selezione" id="seleziona" size="1" maxlength="">
<!-- fine -->
      </td> </tr>	     
<?php          
}
...
##############################  FINE ELENCO CAT CHE NON HANNO MEMORIZZATO IMPORTO PASSIVO PER QUESTO TIPO DI INTERVENTO ###################
?>
</td>
</tr>
</td> 
...
if ($esiste==1) { ?>
<form method="POST" action=""  enctype="multipart/form-data"> 
<table class="table-form "  style="width:98%; position:relative;">
<tr>       
    <td colspan="4" style="text-align: center; " > 
    ...
    <input type="hidden" name="cliente" value="<?php echo $cliente; ?>" /> 
    <input type="hidden" name="commessa" value="<?php echo $commessa; ?>" />  
    <input type="hidden" name="ingranaggioscrivipas" value="1" />
    <button  type="submit" class="btn btn-warning">Memorizza Matrice Passiva per tutti i CAT Selezionati</button>
    </td> 
</form>
  </tr> 
  </table>
...
?>     
	<tr >
      ...
      <td   align="left" bgcolor="<? echo $colore; ?>"><?php echo $pm; ?></td>
