...
if ($ingranaggio==10)
   {
$sql = "DELETE from `caramagazzino` where progr = '$progr'";
#echo $sql;
...
<script type="text/javascript">
        ...
        if(descrizione.value=="") { 
            alert("Error: manca CARATTERISTICA MAGAZZINO"); 
            descrizione.focus(); 
            return false; 
                            } 
...
if ($conn->query($sql) === FALSE) 
    {
    $erroreriferimento="errore codice caratteristiche magazzino già esistente";
    } 
    else
     {
...
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="5" color="#993300">TABELLA CARATTERISTICHE MAGAZZINO</font></b></p>

<form method="POST" action="" name="modulo" onSubmit="return controllo();">

<table class="table-form " >
<tr>		
<td colspan="2" align="center" style="color: #ffffff;background-color: #476b5d; font-size: 16px;" >Caratteristiche Magazzino già inseriti</td>
</tr>
<tr>
...
<?php
$sql1 = "SELECT * FROM `caramagazzino`  ";
#echo $sql1; 
