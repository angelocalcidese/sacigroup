...
-->
      <div align="center" style="background-color: #476b5d;">
			<img border="0" src="ticketing.png" width="370" height="110" style="border-radius: 10px;"> <br>
      </div>
<div align="right">      
      
<a href="../index.php"><font face="Montserrat"><font face="Montserrat" color="#000000" size="1" style="">EXIT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></a>   
      
</div>
<br><br> <br><br><br> <br><br><br> <br>
<div align="center" >
<table id="thetable" style=" border: 0px solid black; background-color: #f0fcaa; " cellspacing="0" width="850" class="table6">	
<tr>
<td>
&nbsp;
</td>
...
<font face="Montserrat" color="#000000" size="4" style="">&nbsp;&nbsp;&nbsp;Area Clienti&nbsp;&nbsp;&nbsp;</font><br><br>
	
<div class="bordered">			
			
<a href="inizio.php" >
	<img border="0" src="cliente.png" width="130" height="110" style="border-radius: 8px;
...
<td align="center" width="270">
<font face="Montserrat" color="#000000" size="4" style="">&nbsp;&nbsp;&nbsp;Operation&nbsp;&nbsp;&nbsp;</font><br><br>
<div class="bordered1">			
				
<a href="inizio.php">	
    <img border="0" src="tic.png" width="130" height="110" style="border-radius: 8px;
box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></a>
</td>
...
<td align="center" width="270">
<font face="Montserrat" color="#000000" size="4" style="">&nbsp;&nbsp;&nbsp;Centri Assistenza Tecnica&nbsp;&nbsp;&nbsp;</font><br><br>
<div class="borderedx">			
				
<a href="../cat/inizio.php">
<img border="0" src="cat.png" width="130" height="110" style="border-radius: 8px;
box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></a>
</td>
