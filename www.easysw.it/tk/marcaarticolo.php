...
if ($ingranaggio==10)
   {
$sql = "DELETE from `marcaarticolo` where progr = '$progr'";
#echo $sql;
...
<script type="text/javascript">
        ...
        if(descrizione.value=="") { 
            alert("Error: manca MARCA ARTICOLO"); 
            descrizione.focus(); 
            return false; 
                            } 
...
if ($conn->query($sql) === FALSE) 
    {
    $erroreriferimento="errore codice marca articolo già esistente";
    } 
    else
     {
...
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="5" color="#993300">TABELLA MARCA ARTICOLO</font></b></p>

<form method="POST" action="" name="modulo" onSubmit="return controllo();">

<table class="table-form " >
<tr>		
<td colspan="2" align="center" style="color: #ffffff;background-color: #476b5d; font-size: 16px;" >Marca Articoli già inseriti</td>
</tr>
<tr>
...
<?php
$sql1 = "SELECT * FROM `marcaarticolo`  ";
#echo $sql1; 
