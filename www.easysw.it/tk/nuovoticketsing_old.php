...
<body>
<?php
$sql1 = "SELECT * FROM luogo  where progr = '$comodoprogr'";
#echo $sql1."<br>";
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc()) 
...
<table width="60%">
 <tr> <tr>
            ...
            <td colspan="3"   align="left" style="border-radius: 3px; border: 0px solid #949699;background: #476b5d;color: ffffff;" > <font face="Verdana"  style="font-size: 10pt;">Luogo intervento: <a href="javascript:MM_openBrWindow('esponiluogo.php?login=<?php echo $login; ?>&chiave=<?php echo $codice; ?>&cliente=<?php echo $cliente; ?>',' ','width=1400,height=450,left=100,top=250');"><img border="0" src="lente1.png" width="15" height="15"></a></font></b>
            </td>
            </tr>
            ...
            <input type="text" name="insegna" value="<?php echo $insegna; ?>" maxlength="200" size="40" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td>
            ...
            <input type="text" name="ragsoc" value="<?php echo $ragsoc; ?>" maxlength="200" size="60" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td>
            </tr>
            <tr><tr>
             ...
             <input type="text" name="contatto" value="<?php echo $contatto; ?>" maxlength="200" size="40" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td>
            ...
            <input type="text" name="cap" value="<?php echo $cap; ?>" maxlength="200" size="5" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            <input type="text" name="prov" value="<?php echo $prov; ?>" maxlength="200" size="5" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            ...
            <input type="text" name="citta" value="<?php echo $citta; ?>" maxlength="200" size="25" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td>
            </tr>
            ...
            <input type="text" name="telefono" value="<?php echo $telefono; ?>" maxlength="200" size="40" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td>
             ...
             <input type="text" name="contatto" value="<?php echo $contatto; ?>" maxlength="200" size="60" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td>
...
if($datainizio==""){$datainizio=$oggi;} ?>           
            ...
            <input type="text" name="tipointervento" value="<?php echo $tipoinervento; ?>" maxlength="200" size="40" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td> 
          ...
          <tr><tr>         
            ...
            <input type="text" name="dataapp" value="<?php echo $dataapp; ?>" maxlength="200" size="20" style="background-color: #ffffff; border-radius: 3px;border: 0px; font-size: 12pt;">
            </td>
            ...
            <textarea style="border: 0px; background-color: #ffffff;font-size: 14pt;color: #000000;" name="nota"  cols="40" rows="1"><?php echo $nota; ?></textarea></td>
            </tr>
