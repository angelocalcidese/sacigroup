...
if($ingranaggio==400){
	$numero=$_REQUEST["numeroxx"];
		#echo "num ".$numero;
	$cliente=$_REQUEST["clientexx"];
	$clienteintero=$_REQUEST["clienteinteroxx"];
	$commessa=$_REQUEST["commessaxx"];
	$attivita=$_REQUEST["attivitaxx"];
	#echo "att ".$attivita;

	$datainizio=$_REQUEST["datainizioxx"];
	#$orainizio=$_REQUEST["orainizio"];
	$tipointervento=$_REQUEST["tipointerventoxx"];
	#echo "ti ".$tipointervento;
	$apparato=$_REQUEST["apparatoxx"];

	$insegna=$_REQUEST["insegnaxx"];
	$ragsoc=$_REQUEST["ragsocxx"];
	$indirizzo=$_REQUEST["indirizzoxx"];
	$cap=$_REQUEST["capxx"];
	$prov=$_REQUEST["provxx"];
	$citta=$_REQUEST["cittaxx"];
	$telefono=$_REQUEST["telefonoxx"];
	$contatto=$_REQUEST["contattoxx"];
	$intervento=$_REQUEST["interventoxx"];

	$nomeparte=$_REQUEST["nomepartexx"];
	$spedizione=$_REQUEST["spedizionexx"];
	$notesla=$_REQUEST["noteslaxx"];
	$nota=$_REQUEST["notaxx"];
	$dataapp=$_REQUEST["dataappxx"];
	$notaapp=$_REQUEST["notaappxx"];


	$priorita=$_REQUEST["prioritaxx"];
	$note=$_REQUEST["notexx"];	
...
if($datainizio==""){$datainizio=$oggi;} ?>           
    ...
    <tr>
      ...
      <td colspan="1"> 
        ...
        <input class="required" type="text" name="seriale" id="seriale" value="<?php echo $seriale; ?>" maxlength="200" size="25" >
      </td>
    </tr>
<? if($priorita==""){$priorita="verde";} ?>
    ...
    <tr>
      ...
      <td height="45" colspan="1"> 
        ...
        <input type="text" class="required" name="note" id="noteF" value="<?php echo $note; ?>" maxlength="200" size="40">
      </td>
      <td colspan="1"> 
...
<div class="table-ticket-footer">
  ...
  ?>     
    ...
    <?php if($ingranaggio!=300 ){ ?>       
		...
		<a style="float:right; color:#000; font-size: 21px;" href="?fileh=<?php echo $file; ?>&login=<?php echo $login; ?>&progrx=<? echo $prgrxx; ?>&ingranaggio=400&numero=<? echo $numero; ?>&clienteintero=<? echo $ragsocclixx; ?>&nomecommessa=<? echo $commessaxx; ?>&attivita=<? echo $attivitaxx; ?>&ticketcli=<? echo $ticketcli; ?>&datainizio=<? echo $datainizioxx; ?>&tipointervento=<? echo $tipointerventoxx; ?>&apparato=<? echo $apparatoxx; ?>&intervento=<? echo $intervento; ?>&serialeparte=<? echo $serialepartexx; ?>&nomeparte=<? echo $nomepartexx; ?>&spedizione=<? echo $spedizionexx; ?>&notesla=<? echo $noteslaxx; ?>&nota=<? echo $notaxx; ?>&dataapp=<? echo $dataapp; ?>&notaapp=<? echo $notaapp; ?>&insegna=<? echo $insegna; ?>&ragsoc=<? echo $ragsoc; ?>&indirizzo=<? echo $indirizzo; ?>&cap=<? echo $cap; ?>&prov=<? echo $prov; ?>&citta=<? echo $citta; ?>&telefono=<? echo $telefono; ?>&contatto=<? echo $contatto; ?> &errore=<? echo $errore; ?>&priorita=<?php echo $priorita; ?>  " >       
