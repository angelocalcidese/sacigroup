...
if ($ingranaggio==10)
   {
$sql = "DELETE from `tipoarticolo` where progr = '$progr'";
#echo $sql;
...
<script type="text/javascript">
        ...
        if(descrizione.value=="") { 
            alert("Error: manca TIPO ARTICOLO"); 
            descrizione.focus(); 
            return false; 
                            } 
...
if ($conn->query($sql) === FALSE) 
    {
    $erroreriferimento="errore codice tipo articolo già esistente";
    } 
    else
     {
...
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="5" color="#993300">TABELLA TIPO ARTICOLO</font></b></p>

<form method="POST" action="" name="modulo" onSubmit="return controllo();">

<table class="table-form " >
<tr>		
<td colspan="2" align="center" style="color: #ffffff;background-color: #476b5d; font-size: 16px;" >Tipi Articoli già inseriti</td>
</tr>
<tr>
