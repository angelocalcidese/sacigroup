...
if ($ingranaggio==10)
   {
$sql = "DELETE from `periodofat` where progr = '$progr'";
#echo $sql;
...
<div align="center">   
<div id="container">
 <p align="center">Tabella Tipi di periodicità di Fatturazione</b></p>

<form method="POST" action="" name="modulo" onSubmit="return controllo();">

<table class="table-form " >
<tr>		
<td colspan="2" align="center" style="color: #ffffff;background-color: #476b5d; font-size: 16px;" >Periodicità Fatturazione già inseriti</td>
</tr>
<tr>
