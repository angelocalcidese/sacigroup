...
<tr onMouseOver="style.background='#c9cacb';" onMouseOut="style.background=''">
        ...
        <a href="?fileh=<?php echo $file; ?>&modificatipo=<? echo $modificatipo; ?>&ingranaggiovedi=201&ingranaggio=11&progr=<? echo $progr; ?>&progrw=<?php echo $cerca; ?>&commessa=<?php echo $commessa; ?>&  nomecommessa=<?php echo $nomecommessa; ?>&attivita=<?php echo $attivita; ?>&notegen=<?php echo $notegen; ?>&commerciale=<?php echo $commerciale; ?>&pm=<?php echo $pm; ?>&ordine=<?php echo $ordine; ?>&  rif=<?php echo $rif; ?>&dal=<?php echo $dal; ?>&al=<?php echo $al; ?>&  login=<?php echo $login; ?>&cliente=<?php echo $clientex; ?>&commessa=<?php echo $commessa; ?>&tipointervento=<?php echo $tipointervento; ?>" >
