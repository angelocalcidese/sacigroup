...
<input type="text" name="dicipass"  size="1" style="background-color: #C0C0C0; font-size: 40px;"> <br>
<input type="hidden" name="ingranaggio" value="1" />
<input type="submit"  value="Registra" name="B3" style="background-color: #79d969; font-size: 30px;"></p>
</form>
<? } else { ?>
<div class="inner" style="background-color: #fcece9;">
<p align="center"><font face="Verdana" size="4" color="#CC0000">INGRESSO IN MENSA<br></font></b></h1><br>
<? if ($ce==0) { ?>
...
<hr>
<form method="POST" action="" name="modulo" >	
<p align="center"><font face="Verdana" size="4" color="#3e36d5">INGRESSO IN MENSA<br></font></b></h1>
<font face="Verdana" size="4" color="#3e36d5">DIGITA NUMERO <b>TESSERA</b></font></b></h1><br>
<input type="text" name="dicitessera"  size="1" style="background-color: #C0C0C0; font-size: 40px;"> <br>
...
if ($gia==1) { ?>
<form method="POST" action="" name="modulo21" >	
<p align="center"><font face="Verdana" size="4" color="#CC0000">TESSERA <? echo $pass; ?><br> GIA' REGISTRATA <br>IN INGRESSO</font></b></h1><br><br>
<font face="Verdana" size="4" color="#000000"><? echo $cognome; ?><br><? echo $nome; ?></font></b></h1><br><br>
<input type="submit"  value="ESCI" name="B5" style="background-color: #cc0000; font-size: 30px;"></p>
</form>
<?  exit;} ?>
