...
<td align"left" bgcolor="#FFFFFF" style="border: 0px ; "><a href="menugenerale.php?login=<?php echo $login; ?>">Menu Generale</a></td>             
...
<p align="center"><b><font face="Arial" size="4" color="#993300">RICERCA 
 DOCUMENTI</font></b></p>
...
<table id="thetable" style=" border: 1px solid black;" cellspacing="0" width="100%" class="table6">	
			  ...
			  <tr>
            <td width="40%" style=" border: 1px solid black;"><font face="Arial" color="#000000">TIPO DOCUMENTO: </td>
            <td width="60%" style=" border: 1px solid black;">
            <font color="#FFFFFF">
            <select size="1" name="tipo" style="background-color: #e4dede; border: 0px; font-size: 12pt; color: #8b8f90;" >
            <option >TUTTI</option>
<?          
...
?>			
            ...
            <? }} ?>
              ...
              <tr>
            <td style=" border: 1px solid black;"><font face="Arial" color="#000000">CLASSIFICAZIONE: </td>
            <td style=" border: 1px solid black;">
            <font color="#FFFFFF">
            <select size="1" name="classe" style="font-size: 12pt; background-color: #e4dede; border: 0px; color: #8b8f90;" >
            <option >TUTTI</option>
<?          
...
?>			
            ...
            <tr>
            <td style=" border: 1px solid black;"><font face="Arial" color="#000000">CLASSE RISERVATEZZA: </td>
            <td style=" border: 1px solid black;">
            <font color="#FFFFFF">
            <select size="1" name="classesic" style="font-size: 12pt; background-color: #e4dede; border: 0px; color: #8b8f90;" >
            <option >TUTTI</option>
<?          
...
?>			
            ...
            <tr>
            <td style=" border: 1px solid black;"><font face="Arial" color="#000000">N. IDENTIFICATIVO DOCUMENTO: </td>
            <td style=" border: 1px solid black;">
            <input type="text" name="numero"  size="30" style="background-color: #e4dede; border: 0px; font-size: 12pt; color: #8b8f90;">
			</td>
			</tr>
            <tr>
            <td style=" border: 1px solid black;"><font face="Arial" color="#000000">NUMERO PROTOCOLLO: </td>
            <td style=" border: 1px solid black;">
            <input type="text" name="protocollo"  size="30" style="background-color: #e4dede; border: 0px; font-size: 12pt; color: #8b8f90;">
			</td>
			</tr>
            <tr>
            <td style=" border: 1px solid black;"><font face="Arial" color="#000000">POSIZIONE FISICA DI ARCHIVIAZIONE: </td>
            <td style=" border: 1px solid black;">
            <input type="text" name="posizione"  size="30" style="background-color: #e4dede; border: 0px; font-size: 12pt; color: #8b8f90;">
			</td>
			</tr>
            <tr>
