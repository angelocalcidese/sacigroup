...
<!-- META SPECIFICI PER DISPOSITIVI MOBILI -->
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="foglio-di-stile.css1" type="text/css" />
...
box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);""> 
      ...
      <font face="Verdana" size="5" color="#3e36d5"<h1><b>TESSERA</b></h1></font>
      </div>
      </td>
      </tr>
   <tr> 
...
<font face="Verdana" size="4" color="#3e36d5">DIGITA NUMERO TESSERA<br></font></b></h1><br>
<input type="text" name="dicitessera"  size="1" style="background-color: #C0C0C0; font-size: 40px;"> <br><br>
<input type="hidden" name="ingranaggio" value="1" />
<input type="submit"  value="Registra" name="B3" style="background-color: #3e36d5; font-size: 40px; color: #ffffff;"></p>
</form>
<? } else { ?>
<div class="inner">
