...
$uploadOk = 1;
#$file_da_cancellare = './home1/poma1.jpg';  
...
$sql = "SELECT *  FROM  home4 where  progr = '1' "; 
...
if ($result->num_rows > 0) {
  ...
  $newimmaggine="img".$numero.$estensione;
   $sql = "UPDATE `home4` SET `immagine`='$newimmaggine'  WHERE `progr` = '1' ";   
    if ($conn->query($sql) === FALSE)
        {echo "errore ".$sql."<br>";} 
          else
        {}     

$myfile = fopen("./home4/poma1.txt", "w") or die("Unable to open file!");
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
...
&& $imageFileType != "gif" && $imageFileType != "JPG") {
    ...
    $uploadOk = 0; echo $imageFileType; exit;
}
...
?>
<script>
window.location.href='cariachome4.php?login=<? echo $login; ?>';
</script>
<?php
}
...
<div id="containerx" align="left"> 
      <td ><a href="menugenerale.php?login=<?php echo $login; ?>">Servizi</a>/Home 4(sito)</td></tr>
</div>
</div>
<br>
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="6" color="#993300">CARICA HOME 4</font></b></p>
...
$file="home4/".$immagine; //ricavo da db il nome dell'inmmagine e gli do il percorso
