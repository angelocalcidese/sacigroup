...
{
$sql = "
DELETE from prenotazionivol where numero = '$tessera'";
...
$sql1 = "SELECT * FROM socivolontari  where tessera = '$socio' ";
#echo $sql1; 
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
...
<p align="center"><b><font face="Arial" size="4" color="#993300">CANCELLAZIONE PRESENZA VOLONTARIO </font></b></p>
      ...
      <tr>
			...
			<tr>
		  	...
		  	<tr>
				...
				<td>				
					<b><font size="3" face="Arial"><?php echo $datainizio; ?></font></b>
				</td>
			</tr>
<!--			<tr>
				<td width="237"><font size="2" face="Arial" color="#000000">- ORA DA:</font></td>
				<td>				
					<b><font size="3" face="Arial"><?php echo $orainizio; ?></font></b>
				</td>
			</tr>	
      	<tr>
				<td width="237"><font size="2" face="Arial" color="#000000">- ORA A:</font></td>
				<td>				
					<b><font size="3" face="Arial"><?php echo $orafine; ?></font></b>
				</td>
			</tr>  -->
		</table>
		</td>
...
<form method="POST" action="">
       ...
       <input type="hidden" name="tessera" value="<?php echo $tessera; ?>" />	
				<td align="center"><input type="submit" value="Cancella" name="B3"></td>
</form>
</body>
