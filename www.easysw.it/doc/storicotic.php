...
datachiusura = '$oggi'
where 
codice = '$tessera' and procedura = 'abacuscalla' 
";
#echo $sql; exit;
if ($conn->query($sql) === TRUE)
    { } 
...
<?php
$sql1 = "select * from ticket  where stato = 'CHIUSO' and procedura = '$logink' order by codice, dataora";
#echo $sql1;
...
?>
<tr>
<td valign="top" style=" border: 1px solid black;background-color: #4e6f9a; color: #ffffff;" ><? echo $codice; ?></td>	
<td valign="top" width=100 style=" border: 1px solid black;background-color: #4e6f9a; color: #ffffff;" >(<? echo $dataora; ?>)</td>	
<td valign="top" style=" border: 1px solid black;background-color: #4e6f9a; color: #ffffff;" ><? echo $argomento; ?></td>
<td valign="top" style=" border: 1px solid black;background-color: #4e6f9a; color: #ffffff;" ><? echo $descrizione; ?></td>
<? if($allegato!=""){?>
...
<? } ?>
<td valign="top" style=" border: 1px solid black;background-color: #4e6f9a; color: #ffffff;" ><? echo $stato; ?></td>
<td valign="top" style=" border: 1px solid black;background-color: #4e6f9a; color: #ffffff;" ><? echo $lavorazione; ?></td>
<td  valign="top" style=" border: 1px solid black;background-color: #4e6f9a; color: #ffffff;"><a href="statotic1.php?fl=<?php echo $allegato; ?>&login=<?php echo $login; ?>&ticket="<? echo $codice; ?> ></a></td>  
...
<tr>
<td valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;" ><? echo $codicew; ?></td>	
<td valign="top" width=100 style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;" >(<? echo $dataoraw; ?>)</td>	
<td valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;" ></td>
<td valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #<?if($tipomessaggio=="C" or $tipomessaggio == "P"){echo "fbf820";}else{echo "ffffff";}?>;" ><? echo $descrizionew; ?></td>
<? if($allegatow!=""){?>
<? $comodo=explode(".",$allegatow);
if($comodo[1] == "pdf"){ ?>
<td  valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;"><a href="JavaScript:carica_consegnaB('esponipdfff.php?fl=<?php echo $allegatow; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<? } else { ?>
<td  valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;"><a href="JavaScript:carica_consegnaB('esponiimage.php?fl=<?php echo $allegatow; ?>&login=<?php echo $login; ?>');" >SI</a></td>  
<?}?>

<? } else { ?>
<td valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;" >NO</td>
<? } ?>
<td valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;" ></td>
<td valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;" ></td>
<td  valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;"><? if($tipomessaggio=="D"){echo "";}else{echo "";}?></a></td>  


<td valign="top" style=" border: 1px solid black;background-color: #<? if($tipomessaggio=="R"){echo "cc0000";}else{echo "4e6f9a";} ?>; color: #ffffff;" ><? if($tipomessaggio=="C"){echo "<a href='?login=$login&ticket=$codicew&ingranaggio=6' >Riapri TK</a>";}?></td>
</tr>
