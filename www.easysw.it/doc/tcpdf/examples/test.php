 ...
 * *********************************************************
 */
//$html = file_get_contents('test_preventivo.php');
// define some HTML content with style
//require_once('test_preventivo.php');
...
//$pdf->Output('preventivo.pdf', 'D');



$output_dest = 'F';
$filename = 'test_preventivo.pdf';
$pdf->Output('/home/siti/www.spi.it/spi.it/htdocs/rootprova/tcpdf/examples/'.$filename, $output_dest);

echo '<a href="http://www.spi.it/rootprova/tcpdf/examples/'.$filename.'">Link sul server</a>';
//============================================================+
// END OF FILE
//============================================================+
