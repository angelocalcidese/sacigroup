...
if ($conn->query($sql) === FALSE) 
    ...
    $erroreriferimento="errore codice volontario già esistente";
     ...
     $url_pagina_chiamante="creatipo.php?login=".$login;?>
    <script>
		top.window.location='<? echo $url_pagina_chiamante; ?>';
		</script> 
    <?php }
...
<tr> 
<td bgcolor="#FFFFFF" style="border: 0px ; "><a href="menugenerale.php?login=<?php echo $login; ?>&codice=2"><font face="Montserrat">Menù Generale</font></a></td>             
<?php
$sql1 = "SELECT * FROM associazione  where login = '$login'";
#echo $sql1; 
    $result = $conn->query($sql1);
...
<div align="center">   
<div id="container">
<form method="POST" action="creatipo.php?login=<? echo $login; ?>" name="modulo" onSubmit="return controllo();">
<h1>
<p align="center"><b><font face="Montserrat" size="4" color="#993300">INSERIMENTO 
TABELLA TIPO DOCUMENTO</font></b></p></h1><h2> 
...
<tr>
<td></td>		
<td style="color: #000000;  font-size: 20px;" ><font face="Montserrat">TIPO DOCUMENTI gia' Inseriti</font></td>
</tr>
<?php
$sql1 = "SELECT * FROM `tipo` where operatore = '$logink'  ";
#echo $sql1; 
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
...
<tr>
<td></td>		
<td style="color: #000000; font-size: 20px;" ><font face="Montserrat">Inserimento nuovo Tipo Documento</font></td>
</tr>


      <tr>
				<td ><font face="Montserrat" color="#ffffff">- TIPO DOCUMENTO</font></td>
				<td>				
					<p>
