...
include "conf_DB.php";
$sql1 = "SELECT a. oggix, COUNT( a.oggix ) AS numero FROM contabacheca a GROUP BY a.oggix
";
...
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc()) 
    ...
    $oggix = $macrogruppo["oggix"];
     ...
     $sesso = $macrogruppo["hh"];
     $values[0][$oggix]=$numero;
...
$settings = [
  ...
  'label_h' => "ACCESSI ALLA BACHECA PER MESE",
  'label_font_size' => 20,
  'label_v' => "visite",
  'data_label_fill' => [
    ['#ccc','#fff','#ccc','h'],
