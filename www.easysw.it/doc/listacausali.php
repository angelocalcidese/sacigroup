...
<div id="containerx" align="left"> 
      <td ><a href="menugenerale.php?login=<?php echo $login; ?>">Menu Generale</a>/<a href="menutabelle.php?login=<?php echo $login; ?>">Menu' Tabelle</a>/Lista Causali</td></tr>
</div>
</div>
<br>
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="6" color="#993300">CAUSALI</font></b></p>
<p align="center"><b><font face="Arial" size="4" color="#993300">(<img border="0" background="btn1.gif" src="pencil.png" width="25" height="25">modifica sk causale)  </font></b></p>
...
?>
	...
	<tr class="first">
      ...
      <td  align="center"><a href="JavaScript:carica_consegnaA('modificacausale.php?anno=<?php echo $anno; ?>&mastro=<?php echo $mastro; ?>&sottomastro=<?php echo $sottomastro; ?>&conto=<?php echo $conto; ?>&codice=<?php echo $codice; ?>');" ><img border="0" background="btn1.gif" src="pencil.png" width="25" height="25"></a></td>
