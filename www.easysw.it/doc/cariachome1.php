...
$sql = "SELECT *  FROM  home1 where  progr = '1' "; 
...
if ($result->num_rows > 0) {
  ...
  $newimmaggine="img".$numero.$estensione;
   $sql = "UPDATE `home1` SET `immagine`='$newimmaggine'  WHERE `progr` = '1' ";   
    if ($conn->query($sql) === FALSE)
        {echo "errore ".$sql."<br>";} 
          else
        {}     

$myfile = fopen("./home1/poma1.txt", "w") or die("Unable to open file!");
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
...
?>
<script>
window.location.href='cariachome1.php?login=<? echo $login; ?>';
</script>
<?php
}
...
<div id="containerx" align="left"> 
      <td ><a href="menugenerale.php?login=<?php echo $login; ?>">Servizi</a>/Home 1(sito)</td></tr>
</div>
</div>
<br>
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="6" color="#993300">CARICA HOME 1</font></b></p>
...
$file="home1/".$immagine; //ricavo da db il nome dell'inmmagine e gli do il percorso
