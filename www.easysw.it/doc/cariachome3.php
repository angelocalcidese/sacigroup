...
$sql = "SELECT *  FROM  home3 where  progr = '1' "; 
...
if ($result->num_rows > 0) {
  ...
  $newimmaggine="img".$numero.$estensione;
   $sql = "UPDATE `home3` SET `immagine`='$newimmaggine'  WHERE `progr` = '1' ";   
    if ($conn->query($sql) === FALSE)
        {echo "errore ".$sql."<br>";} 
          else
        {}     

$myfile = fopen("./home3/poma1.txt", "w") or die("Unable to open file!");
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
...
?>
<script>
window.location.href='cariachome3.php?login=<? echo $login; ?>';
</script>
<?php
}
...
<div id="containerx" align="left"> 
      <td ><a href="menugenerale.php?login=<?php echo $login; ?>">Servizi</a>/Home 3(sito)</td></tr>
</div>
</div>
<br>
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="6" color="#993300">CARICA HOME 3</font></b></p>
...
$file="home3/".$immagine; //ricavo da db il nome dell'inmmagine e gli do il percorso
