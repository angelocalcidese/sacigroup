...
if ($ingranaggio==1)
{
 $nuovologin=$_REQUEST["nuovologin"];
 $passwordnuova=$_REQUEST["nuovapassword"];
 if ($passwordnuova=="")
 {$errore="Password Nuovo Utente non Accettata";}
 else
 {
$tipo=$_REQUEST["tipo"];
...
$nome=$_REQUEST["nome"];
$amministratore=$_REQUEST["amminitratore"];
$visualizza=$_REQUEST["visualizza"];
 $trovato=0;
$sql1 = "SELECT * FROM utenti  where login = '$nuovologin' ";
#echo $sql1; 
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
...
if ($trovato==0) 
{ 
if($amministratore=="NO"){$dio=0;}else{$dio=1;}

$sql1 = "SELECT * FROM progressovol  where progr = '1' ";
#echo $sql1; 
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
		{ $tesseraww = $macrogruppo["progressivo"];	 
			} }
$tesseraww++;
$sql = "UPDATE progressovol set 
progressivo = '$tesseraww'
where 
prg = '1' 
";
...
if ($conn->query($sql) === FALSE)
    ...
    {$errore="Utente Aggiunto con Successo";}
...
<p align="center"><b><font face="Montserrat" size="4" color="#993300">CREAZIONE NUOVO UTENTE</font></b></p>
<p align="center"><b><font face="Montserrat" size="4" color="#993300">Inserisci Password poi dati nuovo Utente</font></b></p> 
...
<table id="thetable" style=" border: 1px solid black;" cellspacing="0" width="760" class="table6">
	...
	<tr class="first" style=" border: 1px solid black;">
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">La tua Password</font></td>
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">
		<input type="password" name="passwordvecchia" size="40"></font></td>
	</tr>
	<tr class="first" style=" border: 1px solid black;">
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">Inserisci email (LOGIN)</font></td>
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">
		<input name="nuovologin" size="40"></font></td>
	</tr>
	<tr class="first" style=" border: 1px solid black;">
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">Inserisci Password di questo LOGIN</font></td>
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">
		<input type="password" name="nuovapassword" size="40"></font></td>
	</tr>

<tr class="first" style=" border: 1px solid black;">
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">Cognome</font></td>
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">
		<input  name="cognome"  size="40"></font></td>
	</tr>
   <tr class="first" style=" border: 1px solid black;">
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">Nome</font></td>
		<td style=" border: 1px solid black;" align="left"><font face="Montserrat">
		<input  name="nome"  size="40"></font></td>
	</tr>
...
?>			
    ...
    <input type="hidden" name="login" value="<?php echo $login; ?>" />
		<td style=" border: 1px solid black;" align="left"><input type="submit" style="height: 22px; background-color: #cc0000;border: 0px; color: #ffffff;" value="Inserisci nuovo Utente" name="B3"></td>
	</tr>
</table>
