...
<tr>
<td align="center">
    <img border="0" id="gfgimage" src="<? echo $nomefile; ?>" width="<? echo $lunghezza;?>" height="75"> 
   <center>
   <b><font face="Arial" size="2" color="#dadcd9"><? echo $intesta1." ".$intesta2; ?></font></b><br>
    <font face="Arial" size="1" color="#dadcd9"><? echo $indirizzo." - ".$localita; ?></font>
</td>
</tr>
</table>
</center>
