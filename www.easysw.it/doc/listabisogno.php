...
<td bgcolor="#FFFFFF" style="border: 0px ; "><a href="menugenerale.php?login=<?php echo $login; ?>&zona=<? echo $zona; ?>">Menu Generale</a>/Lista Codici Bisogno Rilevato</td>
<?php
...
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="6" color="#993300">ELENCO CODICI BISOGNO RILEVATO</font></b></p>
...
<div id="container">
  ...
  <?php
$totale=0;
$sql = "SELECT *  FROM  bisogno order by codice"; 
#echo $sql;
$rCount = 1;
