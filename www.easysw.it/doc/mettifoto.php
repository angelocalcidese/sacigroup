...
<title>carica foto assistito GVV Baggio</title>
</head>
<style>
div#container {
min-width:   870px;
...
<table border="0" width="100%">
	<tr>
		<td><p align="center"><b><font face="Arial" size="5" color="#993300">INSERIMENTO FOTO</font></b></p></td>
	</tr>
	<tr>
...
<?php if($ingranaggio==2) {echo " foto inserita";} ?>
</font></b></p></td>
	</tr>
</table>
...
?>          
      ...
      <tr>
				<td width="237"><font face="Arial" color="#000000">- FOTO</font></td>
				<td>
       ...
       <input type="hidden" name="tessera" value="<?php echo $tessera; ?>" />
			<tr>
				<td width="237">&nbsp;</td>
				<td><input type="submit" value="Inserisci foto" name="B3"></td>
			</tr>
		</table>
		</td>
	</tr>
