...
$uploadOk = 1;
#$file_da_cancellare = './chisiamo/poma1.jpg';  
...
if ($result->num_rows > 0) {
  ...
  $newimmaggine="img".$numero.$estensione;
   $sql = "UPDATE `chisiamo` SET `immagine`='$newimmaggine'  WHERE `progr` = '1' ";   
    if ($conn->query($sql) === FALSE)
        {echo "errore ".$sql."<br>";} 
          else
        {}     

$myfile = fopen("./chisiamo/poma1.txt", "w") or die("Unable to open file!");
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
$txt = $newimmaggine."\n";
fwrite($myfile, $txt);
...
?>
<script>
window.location.href='caricachisiamo.php?login=<? echo $login; ?>';
</script>
<?php
}
...
<div id="containerx" align="left"> 
      <td ><a href="menugenerale.php?login=<?php echo $login; ?>">Servizi</a>/Chi Siamo(sito)</td></tr>
</div>
</div>
<br>
<div align="center">   
<div id="container">
<p align="center"><b><font face="Arial" size="6" color="#993300">CARICA CHI SIAMO IN SITO</font></b></p>
...
$file="chisiamo/".$immagine; //ricavo da db il nome dell'inmmagine e gli do il percorso
