...
if ($conn->query($sql) === FALSE) 
    ...
    $erroreriferimento="errore codice volontario già esistente";
     ...
     $url_pagina_chiamante="creaclassesic.php?login=".$login;?>
    <script>
		top.window.location='<? echo $url_pagina_chiamante; ?>';
		</script> 
    <?php }
...
<div align="center">   
<div id="container">
<form method="POST" action="creaclassesic.php?login=<? echo $login; ?>" name="modulo" onSubmit="return controllo();">
<h1>
<p align="center"><b><font face="Montserrat" size="4" color="#993300">INSERIMENTO 
TABELLA CLASSE SICUREZZA DOCUMENTO</font></b></p></h1><h2> 
...
<tr>
<td></td>		
<td style="color: #000000; font-size: 20px;" ><font face="Montserrat">CLASSE SICUREZZA DOCUMENTO gia' Inseriti</font></td>
</tr>
<?php
$sql1 = "SELECT * FROM `classesic` where operatore = '$logink' ";
#echo $sql1; 
$result = $conn->query($sql1);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())
...
<tr>
<td></td>		
<td style="color: #000000; font-size: 20px;" ><font face="Montserrat">Inserimento nuovo Classe SicurezzaDocumento</font></td>
</tr>


      <tr>
				<td ><font face="Montserrat" color="#ffffff">- CLASSE SICUREZZA DOCUMENTO</font></td>
				<td>				
					<p>
