...
function ShowCalendar($m,$y)
{
  ...
  <td colspan=\"".$cols."\">
  <a href=\"?d=" . $precedente . "\"><img src=\"indietro.png\" width=\"30\" height=\"30\"></a>
  "  .$nomi_mesi[$m-1] . " " . $y . " 
  <a href=\"?d=" . $successivo . "\"><img src=\"destro.png\" width=\"30\" height=\"30\"></a></td></font></tr></div>";
  ?>
  <div align="center">
...
$sql1x = "SELECT * FROM prenotazioni  where camera = '$camera'";
#echo $sql1x;  exit;
...
while($macrogruppoxx = $resultxx->fetch_assoc()) 
    ...
    if (($data==$datainiziox or  $data > $datainiziox)and ($data < $datafinex)) {$sw=1;}   
     }}
     $sw2="";
    ...
    $sw2='<font size="2">';
        ...
        */
        if($sw==1){
        if($confermato=="SI") {$colore=$verde;}  
        if($confermato=="NO") {$colore=$rosso;}  
        if($dataentrata!="0000-00-00") {$colore=$giallo;} 
        if($datauscita!="0000-00-00") {$colore=$blu;}      
        } else {$cognome="";} 
        ?><td bgcolor="<? echo $colore; ?>"><div class="tooltip"><font color="#ffffff"><a href="JavaScript:carica_consegnaA('stampask.php?tessera=<?php echo $numero; ?>');"><? echo $sw2; ?><? echo $cognome; ?></font>        </a></font><span class="tooltiptext"><? echo $cognome." ".$nome."<br>".$datainizio;?></span>
</div></td>
...
a { text-decoration: none; font-weight: bold; color: #FFFFFF } a:hover { color: #0080FF; }
.bordered:hover {
