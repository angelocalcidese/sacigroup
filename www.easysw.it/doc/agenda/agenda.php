...
function ShowCalendar($m,$y,$zx)
{
  ...
  <? echo "Volontario ".$codice." ".$cognome." ".$nome; ?></b></font> </div><br><?
  ...
  echo "</tr>";
  echo "<td><img src=\"carlopoma.png\" width=\"70\" height=\"30\"></td>";
  #echo $days." ".$lunedi;
...
$sql1x = "SELECT * FROM prenotazionivol  where camera = '$camera' and socio = '$codice'";
  ...
  while($macrogruppox = $resultx->fetch_assoc()) 
    ...
    $sw2='<font size="2">';
      ...
      <? if ($colore== "#f61f24"  or $colore== "#07e837" or $colore== "#c19bdf"){ ?>
       <a href="JavaScript:carica_consegnaC('../cancellaatt.php?tessera=<?php echo $numerox; ?>');">
       <? }else { 
       if ($colore== "#faf82a"){  ?>
      <a href="JavaScript:carica_consegnaC('../../partenzaxx.php?tessera=<?php echo $numerox; ?>');">
      <? } else {              ?>
      <a href="JavaScript:carica_consegnaA('../cancellaatt.php?tessera=<?php echo $numerox; ?>');">
      <? } }echo $sw2; 
   ...
   $datarr = (date($day."/".$m."/".$y)); ?>
   <a href="JavaScript:carica_consegnaB('../mettipresenza.php?data=<?php echo $datarr; ?>&tessera=<? echo $codice; ?>&camera=<? echo $camera; ?>');"><font color="#ffffff" >aa</font></a>
...
function carica_consegnaA(url){
	<!-- intestazione -->	
    popupWindow =
		window.open(url,'pdf','width=900,height=450,left=150,top=150,location=0,directories=0,toolbar=0,scrollbars=yes,resizable=1')
...
function carica_consegnaB(url){
	<!-- intestazione -->	
    popupWindow =          
		window.open(url,'pdf','width=900,height=450,left=150,top=150,location=0,directories=0,toolbar=0,scrollbars=yes')
    //	window.open('esponipdf1x.php?offerta='+offerta,'offerta','width=1200,height=800,left=150,top=150,location=0,directories=0,toolbar=0')
		//return false;
