...
$sql = "UPDATE tk set 
        ...
        if ($conn->query($sql) === TRUE)
          {
          $dicichi="Modificato Stato in Richiesta di chiusura ".$catscelto;
...
VALUES ( 
 ...
 '$numerointerventox'
  ...
  if ($conn->query($sql) === TRUE)
        {
        $dicichi="Memorizzato parte di ricambio Installata ".$catscelto;
     $dataoggi=date("Ymd H.m.s");
         $sqluu = "INSERT INTO storia
        (ticket,
        dataazione,
...
$sql = "UPDATE tk set 
        ...
        if ($conn->query($sql) === TRUE)
          {
          $dicichi="Modificato Stato in parte di ricambio Installata ".$catscelto;
     $dataoggi=date("Ymd H.m.s");
         $sqluu = "INSERT INTO storia
        (ticket,
        dataazione,
...
$sql = "UPDATE tk set 
        stato = 'Pianificato'
        where 
        numero = '$numero' and  stato = 'Assegnato' 
        ";
        if ($conn->query($sql) === TRUE)
          { } 
          else { echo "Error inserted record: " . $conn->error; }         
...
if ($conn->query($sql) === FALSE)
  ...
  {
  $dicichi="Cancella documento ".$catscelto;
     $dataoggi=date("Ymd H.m.s");
         $sqluu = "INSERT INTO storia
        (ticket,
        dataazione,
...
if ($conn->query($sql) === TRUE)
    {
    $dicichi="Modifica Ticket "." ".$numero." ".$catscelto;
     $dataoggi=date("Ymd H.m.s");
         $sqluu = "INSERT INTO storia
        (ticket,
        dataazione,
...
<? } ?>
    ...
    <li class="nav-item">
      <a class="nav-link <? if($ingranaggioy==51){echo "active";} ?>" href="gestticket.php?login=<? echo $login; ?>&codice=<?php echo $numero; ?>&ingranaggioy=50" title="Indietro"><span>
    ...
    <li class="nav-item">
      ...
      <i class="fa-solid fa-folder-closed"></i> Memorizza Intervento 
      </a>
    </li>
...
<?
$sql = "SELECT * FROM pianificato  where    codice = '$numero' and login = '$login'";        
#echo $sql;
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($macrogruppo = $result->fetch_assoc())	
...
?>
<p align="center"><font face="Verdana" size="5" color="#993300" style="font-family: Verdana;">Richiesta di Chiusura del Ticket <?php echo $numero." Stato ".$stato; ?></font></b></p>
...
<table  class="display" cellspacing="0" align="center" style="width:95%; position:relative;">         
             <thead class="intesta">
	<tr class="testa">
          ...
          <td  style=" border: 1px solid black;background-color: #476b5d; color: #ffffff;font-family: Verdana;" align="center"><font size="2" face="Verdana" >Cliente<br>Commessa<br>Attività<br>Tipo Intervento</td>        
      	 

         
<!--          <td  style=" border: 1px solid black;background-color: #476b5d; color: #ffffff;font-family: Verdana;" align="center"><font size="4" face="Verdana" >Apparato<br>Seriale</td>            
          <td  colspan="1" style="  border: 1px solid black;background-color: #476b5d; color: #ffffff;font-family: Verdana;" align="center"><font size="4" face="Verdana" >N. Ticket Cliente</td> -->
...
?>     
    <tr >
      ...
      <font size="4" color="#cc0000" face="Verdana"><?php echo $numeroxx; ?> </font>        
      <br>
      <font size="3" color="#000000" face="Verdana"><?php echo $ticketcli; ?></font>
      <br>
    <?php if($priorita=="rosso"){ ?>
...
<?php } ?>    
      ...
      <td valign="top" style=" border: 1px solid #e4e3e3;font-family: Verdana;" align="left" ><font size="2" face="Verdana"><?php echo $ragsocclixx."<br>".$nomecommessaxx; ?><br><?php echo $attivitaxx."<br>".$tipointerventoxx; ?></font></td>
...
<p align="center"><font face="Verdana" size="5" color="#993300" style="font-family: Verdana;">Ticket <?php echo $numero; ?> Intervento Pianificato</font></b></p>

<table class="table-form" style="width: 95%;">        
        <tr>
        <th style="font-size: 15px;" style="text-align:center;" colspan="1" class=" borted-top-table" width="5%"> 
        <b>N.Int.
        </th>
		<th  style="font-size: 15px;" colspan="1" class=" borted-top-table" width="10%"> 
        <b>Data<br>Ora
        </th>
        <th  style="font-size: 15px;" colspan="1" class=" borted-top-table" width="30%"> 
        <b>luogo<br>Tecnico
        </th>
        <th  style="font-size: 15px;" colspan="1" class=" borted-top-table" width="30%" > 
        <b>Note
...
<tr>
<form method="POST" action=""  enctype="multipart/form-data">
        <td   style="text-align:center;" colspan="1"  style="font-size: 20px;"><? echo $numerointervento; ?></td>
		<td   colspan="1"  style="font-size: 12px;"><? echo $dataint; ?><br><? echo $oraint; ?></td>      
        <td   colspan="1" style="font-size: 12px;"><? echo $luogoint; ?><br><br><? echo $tecnicoint; ?></td>
        <td   colspan="1" style="font-size: 12px;"><? echo $noteint; ?></td> 
        ...
        <button autofocus type="submit" class="btn btn-success"  style="font-size: 15px;">Seleziona</button>
        </td> 
</form>
        </tr>        
...
<table class="table-form" style="width: 95%;">
  <tr>
      <th colspan="2" class=" borted-top-table" style=";font-size: 15px;"> 
       <b> Intervento: </b>
      </th>
  </tr>
  <tr>
...
<tr>
      <th colspan="1" class=" borted-top-table" style="width: 30%; background: #afc81b;;font-size: 15px;"> 
        <b>Seriale</b>
      </th>
      <th colspan="1" class=" borted-top-table" style="width: 70%; background: #afc81b;;font-size: 15px;"> 
        <b>Descrizione Parte</b>
      </th>
  </tr>  
<? 
...
<table class="table-form" style="width: 95%;">    
<tr>
      <th style="font-size: 15px;"colspan="2" class=" borted-top-table"> 
        <b>Parti installate:</b>
      </th>
  </tr>
    <tr>
      <td colspan="1" > 
...
<table class="table-form" style="width: 95%;">        
        ...
        <th style="font-size: 15px;" colspan="1" class=" borted-top-table" width="70%"> 
        <b>Oggetto </b>
        </th>
        <th style="font-size: 15px;"colspan="2" class=" borted-top-table" width="10%" style="text-align:center;"> 
        <b>Operazioni</b>
        </th>
        </tr> 
...
<tr onMouseOver="style.background='#c9cacb';" onMouseOut="style.background=''">
		...
		<td  style="color: <?php if($prgr==$prgry){echo "#cc0000";}else{echo "#000000";} ?>;font-size: 12px;"><? echo $data; ?></td>
        <td  style="color: <?php if($prgr==$prgry){echo "#cc0000";}else{echo "#000000";} ?>;font-size: 12px;"><? echo $datasca; ?></td>
        
        <td  style="color: <?php if($prgr==$prgry){echo "#cc0000";}else{echo "#000000";} ?>;font-size: 12px;"><? echo $oggettox; ?></td>
